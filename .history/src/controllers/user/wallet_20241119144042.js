...
const  walletAddCart  =  async  ( req , res ) =>{
    try{
        ...
        if(cartTotal - couponBalance  < user.walletBalance ){
            return res.status(200).json({ success : false , message : `Cart should have minimum ${user.walletBalance} for ordee`})
        }
