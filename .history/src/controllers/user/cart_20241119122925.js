...
const getCart = async ( req,res ) => { 
   ...
   let totalP = parseFloat(totalPrice.toFixed(2)) ;
    ...
    console.log(cart.walletDiscount,"wallet")
    ...
    return res.render("frontend/cart.ejs" , { logo , user , userId , cart , totalItems , totalAmount , couponDiscount,walletDiscount, totalPrice  , genderCategory ,cartTotal }) ; 
  }
  else{
