...
const products = async ( req , res ) => { 
    ...
    const user = await User.findById(req.session.userId) || re // assuming user is authenticated and stored in session
    ...
    res.render("frontend/products-page", { logo, genderCategory, user,userId : user._id ,  products, cartTotal });
  }catch(err){
    console.log(err);
