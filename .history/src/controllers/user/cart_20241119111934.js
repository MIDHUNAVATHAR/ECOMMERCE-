...
const getCart = async ( req,res ) => { 
   ...
   let totalP = parseFloat(totalPrice.toFixed(2)) ;
    ...
    await cart.save(); 
   console
    return res.render("frontend/cart.ejs" , { logo , user , userId , cart , totalItems , totalAmount , couponDiscount, totalPrice : totalP , totalAmount , genderCategory ,cartTotal }) ; 
  }
  else{
