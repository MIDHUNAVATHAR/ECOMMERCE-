...
const  addProduct   =   async  ( req , res )  => {
    try{
        ...
        res.render("backend/admin-dashboard.ejs" ,{ message : '' , admin : req.session.adminEmail , partial : "partials/add-product" , genderCategories , productCategories  }) ;  
    }catch(err){
        console.log(err) ;
    ...
    uploadProduct(req, res, async function (err) {
        ...
        try {
             ...
             let {
                 ...
                 genderCategory, productCategory, pr, size , quantity , price ,
             } = req.body ;
...
const  listProducts  =   async  ( req , res ) =>{
    ...
    try{
        ...
        res.render("backend/admin-dashboard.ejs" ,{message : '', admin : req.session.adminEmail , partial : "partials/product-list" , products , totalPages ,
...
const  editProduct  =  async  ( req , res  )  =>{
    try{
        ...
        res.render("backend/admin-dashboard.ejs" ,{message : '',admin : req.session.adminEmail , partial : "partials/edit-product" , genderCategories , productCategories , productSubCategories , product}) ; 
    }catch(err){
        console.log(err) ;
        res.status(500).render("frontend/404") ;        
    }
