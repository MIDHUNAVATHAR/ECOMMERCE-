...
const  addProduct   =   async  ( req , res )  => {
    try{
        ...
        res.render("backend/admin-dashboard.ejs" ,{ message : '' , admin : req.session.adminEmail , partial : "partials/add-product" , genderCategories , productCategories , productSubCa }) ;  
    }catch(err){
        console.log(err) ;
