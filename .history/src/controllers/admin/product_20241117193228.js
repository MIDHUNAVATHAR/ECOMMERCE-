...
const  editProduct  =  async  ( req , res  )  =>{
    try{
        ...
        res.render("backend/admin-dashboard.ejs" ,{message : '',admin : req.session.admin.mail , partial : "partials/edit-product" , genderCategories , productCategories , productSubCategories , product}) ; 
    }catch(err){
        console.log(err) ;
        res.status(500).render("frontend/404") ;        
    }
